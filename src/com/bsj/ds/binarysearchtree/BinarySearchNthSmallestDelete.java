...
public class BinarySearchNthSmallestDelete {
    int elementIndex = 0;
    ...
    //Node root=null;
    public Node deletenthSmallest(Node root, int count) {
        preOrder(root, count);
    ...
    public static void main(String[] args) {
        ...
        binarySearchTree = new BinarySearchNthSmallestDelete().deletenthSmallest(binarySearchTree, 6);
